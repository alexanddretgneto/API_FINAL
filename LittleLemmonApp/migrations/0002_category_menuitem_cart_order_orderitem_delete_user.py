    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='LittleLemmonApp.category')),
            ],
        ),
        migrations.CreateModel(
            name='Cart',
            fields=[
                ...
                ('menuitem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='LittleLemmonApp.menuitem')),
            ],
            options={
